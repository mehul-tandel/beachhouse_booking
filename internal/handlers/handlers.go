...
func (m *Repository) Home(w http.ResponseWriter, r *http.Request) {
	...
	render.RenderTemplate(w, r, "home.page.html", &models.TemplateData{}) //passing pointer to an empty template
}
...
func (m *Repository) BlueCottage(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "blue-cottage.page.html", &models.TemplateData{})
}

// OrangeSuite renders the room page
func (m *Repository) OrangeSuite(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "orange-suite.page.html", &models.TemplateData{})
}
